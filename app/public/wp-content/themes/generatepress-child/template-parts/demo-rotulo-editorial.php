...
<section class="rotulo-editorial-demo">
	<header class="rotulo-editorial-demo__header">
		<p class="rotulo-editorial-demo__eyebrow">Prueba visual</p>
		<h1 class="rotulo-editorial-demo__title">Rótulo editorial</h1>
		<p class="rotulo-editorial-demo__intro">Esta referencia enseña cómo se vería el nuevo sistema de titulares gráficos directamente dentro del tema, sin usar imágenes rasterizadas.</p>
	</header>
			...
			<div class="rotulo-editorial">
				<div class="rotulo-editorial__franja rotulo-editorial__franja--superior">
					...
					<span class="rotulo-editorial__union">
						<span class="rotulo-editorial__texto rotulo-editorial__texto--superior">1920-1930</span>
					</span>
				</div>
